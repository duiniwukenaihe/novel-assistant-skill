...
setup() {
  ...
  printf '%s\n' '{"project_id":"short-brief-fixture","project_title":"档案复核","plan_revision":1,"current_section_index":1,"accepted_sections":[]}' > "$TMP_DIR/book/追踪/private-short-extension/project-state.json"
  printf '# 素材卡\n凭证复核事件\n' > "$TMP_DIR/book/素材卡.md"
  printf '# 设定\n第一人称阿岚\n' > "$TMP_DIR/book/设定.md"
