...
## 主要人物
### 阿岚，27岁，女主
第一人称“我”。她要查清凭证事故并保护被甩锅的员工，最怕失去团队的支持；误区是把主管的保证当成事实。她不懂凭证、财务和法律，最终必须亲自撤回错误背书并承担公开纠错的代价。

### 主管，39岁，压力角色
部门负责人。他要保住部门、订单和员工工资，认为暂时隐瞒能救机构；拥有经营权限，但不能无成本伤人，也必须承担错误决策的职位代价。

## 角色锁定卡
| 角色名 | 性别/称谓/视角身份 | 年龄/职业 | 与主角关系 | 本篇目标 | 行动边界 |
|---|---|---|---|---|---|
| 阿岚 | 女，第一人称“我” | 27岁，合规专员 | 当事人 | 查清事故并保护员工 | 不突然精通商业与法律 |
| 主管 | 男，称“主管” | 39岁，负责人 | 上级/压力角色 | 保住部门和控制权 | 不调用神秘关系解决危机 |
...
## 第1节：复核翻车
- 结构功能：开篇。
- 场景动作：主角主动复核回应质疑，当场发现凭证空缺。
- 角色选择：主角拒绝停止，当场追问档案为何是空的。
- 开篇钩子：宣称真实归档的复核间后方没有一条凭证。
...
- 角色选择：主角拒绝签署甩锅声明。
- 可见阻力：主管用部门存亡和员工生计逼她沉默。
- 本节兑现：播放日志证明出错素材早在三年前就被上传。
- 关系变化：主角从信任主管转为保护员工并独立查证。
- 代价升级：她失去主管保护，并成为部门危机的第一责任人。
- 核心承诺兑现：她第一次公开选择真相而不是关系。
- 决定性行动：她备份日志并联系独立审查方。
- 即时代价：主管取消她的部门权限。
- 子事件：
  1. 管理层逼员工背锅。
  2. 主角调取日志并备份证据。
- 情绪目标：信任到动摇。
- 压力变化：主角从网络质疑转入部门与员工之间的正面冲突。
- 因果链：甩锅 -> 查日志 -> 旧素材。
- 节尾钩子：三年前上传。
## 第3节：我先认错
- 结构功能：高潮与结尾。
- 承接上节：三年前上传的素材迫使主角公开核对部门承诺。
- 场景动作：主角在复核中公布脱敏证据并启动纠错。
- 角色选择：她先承认自己的传播责任，不把过错推给员工。
- 现实后果：流程纠错、部门停产、主角退还报酬。
- 关系收束：她与主管保持裂痕，不写突然和解。
- 主题回扣：从部门故事背书转向只说自己能核实的事。
- 子事件：
  1. 主角公布证据并认错。
  2. 纠错与关系代价真正落地。
- 情绪目标：恐惧到承担。
...
## 第1节：复核发现凭证空缺
- 承接与场景动作：主角主动复核回应质疑，当场发现凭证空缺。
- 可见阻力与压力变化：主管要求她按统一口径解释，舆论开始质疑流程。
- 主角选择与兑现：她拒绝甩锅导播，保留复核回放并追问原始记录。
- 关系后果、代价与钩子：主管停掉她的权限；旧记录显示三年前已经没有凭证归档。
- 开篇钩子：宣称真实归档的复核间里没有一条凭证。
- 故事承诺：她必须在部门利益与知情权之间作出选择。
- 因果链：回应质疑 -> 误切凭证空缺 -> 拒绝甩锅 -> 权限被停。

## 第2节：记录早已过期
- 承接与场景动作：主角核对原始记录并当面质问管理层。
- 承接上节：凭证空缺的复核迫使主角追查原始记录。
- 可见阻力与压力变化：主管用团队考核和合作方追责逼她沉默。
- 主角选择与兑现：她备份记录并联系独立审查方。
- 核心爆点兑现：原始记录证明部门承诺与真实归档长期相反。
- 决定性行动：她把证据交给独立审查方并拒绝撤回。
- 关系后果、代价与钩子：她失去主管保护，并发现凭证流程已经移交。
- 因果链：查记录 -> 发现断档 -> 备份证据 -> 找到档案交易。

## 第3节：复核里重新有了凭证
- 承接与场景动作：部门停用旧档，主角提交纠错与整改方案。
- 承接上节：档案交易证据迫使部门停止旧流程。
- 可见阻力与压力变化：停用后的考核、合作和团队压力同时落地。
- 主角选择与兑现：她推动独立复核和真实凭证回流并复核。
- 关系收束：主管停职退出治理，信任没有立刻恢复。
- 现实后果：旧流程停用、更正通知发出、责任人接受内部调查。
- 主题回扣与结尾钩子：复核里终于有凭证，所有批次继续公开接受核验。
- 因果链：停用纠错 -> 承担停用代价 -> 恢复真实归档 -> 长期公开。
EOF
...
## 第1节：协作工具用她的原话反问她
**开篇钩（opening_hook）**：协作工具第一次用阿岚只给系统看过的话反问她。
**故事承诺**：她必须查清自己的草稿如何被加工成公开内容。
**场景动作**：阿岚对照本地导出与历史发言，保存第一份本地证据。
**主角选择**：她没有关闭软件，而是决定继续比对并留下证据。
**因果事件（causal_events）**：同事催稿 → 她向工具抱怨 → 工具复述私密句式 → 她打开本地导出。
**情绪目标**：依赖转为警觉。
...
## 第1节：复核翻车
- 结构功能：开篇。
- 场景动作：主角主动复核回应质疑，镜头误切到凭证空缺。
- 角色选择：主角拒绝停止，当场追问档案为何是空的。
- 开篇钩子：宣称真实归档的复核间后方没有一条凭证。
- 故事承诺：主角将在团队与真相之间做出不可退回的选择。
- 子事件：
  1. 主角用机构身份为流程背书。
  2. 公开核验让谎言暴露。
- 情绪目标：自信到茫然。
...
- 场景动作：主角在公开复核会上公布脱敏证据并撤回错误结论。
- 角色选择：她先承认自己的传播责任，不把过错推给员工。
- 现实后果：结论撤回、部门停审、主角退还报酬。
...
@test "short plan contract blocks a disconnected cross-section hook" {
  perl -0pi -e 's/承接上节：凭证空缺的复核画面逼主角追问原始现场。/承接上节：主角忽然收到一封与复核无关的匿名信件。/' "$BOOK/小节大纲.md"
