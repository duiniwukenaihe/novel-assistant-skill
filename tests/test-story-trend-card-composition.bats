...
const fs=require('fs');
const file=process.argv[2];
const info={card_type:'info_source_card',info_id:'info-1',source_refs:[{url:'https://example.com/1'}],factual_summary:'机构虚假宣传',human_conflict:'员工生计与知情权冲突',verdict:'write',route_fit:['番茄短篇'],scorecard:{material_score:9},learning_notes:{source_pattern:'组织隐瞒',reusable_conflict_pattern:'关系包庇',platform_signal:'热榜',query_expansion_hint:'职场合规',next_reuse_rule:'主角必须承担现实代价'}};
const material={card_type:'material_card',canonical_id:'mat-1',source_type:'online',source_info_ids:['info-1'],source_refs:[{url:'https://example.com/1'}],title:'档案缺失复核',event_summary:'复核员发现归档造假',human_conflict:'关系与真相',emotion_trigger:'愤怒',protagonist_seed:'部门新人',immediate_stakes:'沉默会继续欺骗当事人',actionable_choice:'复核公开证据并接受停职',extractable_hotspots:['hot-1']};
const hotspot={card_type:'hotspot_card',hotspot_id:'hot-1',source_material_ids:['mat-1'],hotspot_line:'复核镜头转向编号空缺',reader_desire:'公开反打',emotional_entry:'背叛',power_relation:'下属对部门董事会',oppressor:'主管与虚假宣传',protagonist_action:'复核公开档案和账册',escalation_trigger:'主管冻结账号并威胁员工工资',counterattack_method:'向监管提交录音与批次记录',reversal_method:'监管当场封存宣传材料',payoff_shape:'旧档纠错退款，真实归档流程整改后公开复归',reusable_scene:'复核会和董事会',platform_fit:['番茄短篇']};
const topic={card_type:'topic_card',topic_id:'topic-1',primary_hotspot_id:'hot-1',target_platform:'番茄短篇',title_candidates:['我复核档案现场，编号里却没有凭证'],genre_lane:'现实反打',opening_scene:'全网逼问她敢不敢拍归档流程',story_promise:'她会亲手拆穿部门并承担复归代价',protagonist_pressure:'公开会失去团队与职位，沉默会继续欺骗当事人',antagonist_pressure:'主管冻结权限并拿员工工资施压',irreversible_choice:'她切断官方复核，改用私人账号公开账册并向监管举报',escalation_beats:['主管冻结权限，她公开录音反证','董事会要求删稿，她提交批次记录触发监管进厂','员工质问工资，她公开保障方案并投票暂停主管职务'],first_reversal:'监管调取账册后当场封存宣传材料，主管第一次失去控制权',final_payoff:'机构召回退款并停产整改，三个月后真实凭证归档流程恢复复核，当事人可核验批次',expected_length:'10000字'};
fs.writeFileSync(file,JSON.stringify({info_source_cards:[info],material_cards:[material],hotspot_cards:[hotspot],topic_cards:[topic]}));
NODE
    run python3 "$PIPELINE" validate "$fixture"
