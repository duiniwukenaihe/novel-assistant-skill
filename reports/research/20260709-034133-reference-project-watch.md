...
- Checked at: `2026-07-09T03:41:33.014Z`
...
| `current` | wen1701/FanqieRankTracker | `main` | `5a0315e0aeaf` | `current` | - | `none` | `-` | `5a0315e0aeaf` | `reference-high` | `MIT-confirmed-in-private-download-docs` | `compatible-implementation-review` | `no_action` | fanqie_font_decode, ranking_scrape, book_id_extraction, anti_scraping_boundary |
...
| `current` | yangsonhung/awesome-agent-skills | `main` | `c3c05835bbf3` | `current` | - | `none` | `-` | `c3c05835bbf3` | `reference-low` | `curated-links-check-target-license` | `discovery-index-only` | `no_action` | skill_discovery, agent_skill_patterns |
