...
HOOK_FILE="$REPO_ROOT/src/internal-skills/story-setup/references/templates/hooks/detect-story-gaps.sh"
COMMON_FILE="$REPO_ROOT/src/internal-skills/story-setup/references/templates/hooks/lib/common.sh"
PROTOCOL_FILE="$REPO_ROOT/src/internal-skills/story-long-write/references/artifact-protocols.md"
