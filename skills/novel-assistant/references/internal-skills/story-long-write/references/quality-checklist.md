...
- [ ] 破折号门禁：正文标题行以外 `——`/`—`/`--` 允许合理少量、有功能使用。同一章破折号密度失控、逐字破折号化是明显 AI 味和坏稿阻断项；先运行 `normalize-punctuation.js`，再回炉重写或人工改成动作、短句、逗号或句号断开
...
> 破折号门禁统一补充：正文标题行以外不反复堆砌 `——`/`—`/`--`；逐字破折号化必须回炉重写，不得机械删除后宣布完成。
