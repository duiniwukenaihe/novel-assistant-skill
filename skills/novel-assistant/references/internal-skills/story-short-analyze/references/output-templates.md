...
| Stage 4 反转+写作手法 | Stage 4 反转分析 + 写作手法 + 人性共鸣学习卡 | 前置反转检查 + 铺垫线索 ≥2 + 手法 ≥5 项 + 共鸣学习卡 ≥3 张 |
| Stage 5 人物+开头结尾 | Stage 5 人物 + 开头/结尾 | 所有有名人物 + 前 3 句引用 + 结尾类型 |
| Stage 6 评估报告 | Stage 6 综合评估 | 五维评分 + 爆点性 + 共鸣 ≥3 层 + 共鸣机制回收 + 可借鉴结构 ≥3 条 |
| 同类对比（可选） | 同类对比 | 差异化亮点 |
...
> 输出到 `写作手法.md`，供 `story-short-write` / 私有短篇模块开新篇前读取。学习的是机制，不是桥段换皮。

| 卡片 | 原文节点 | 人物软肋 | 关系压力 | 生活物件/数字/旧话 | 选择代价 | 情绪债兑现 | 可迁移机制 | 禁抄提醒 |
|------|----------|----------|----------|---------------------|----------|------------|------------|----------|
| H1 | {节N/节点N} | {主角怕失去什么/不愿承认什么} | {谁逼谁/谁欠谁/谁不敢说} | {具体物件或数字} | {主动选择付出的代价} | {前文委屈/误解/羞辱如何兑现} | {抽象成新故事可用机制} | {不能照搬的人物关系/台词/场面} |
| H2 | {节N/节点N} | {...} | {...} | {...} | {...} | {...} | {...} | {...} |
| H3 | {节N/节点N} | {...} | {...} | {...} | {...} | {...} | {...} | {...} |

质量要求：至少 3 张；每张必须同时有“原文节点 + 软肋 + 关系压力 + 生活物件/数字/旧话 + 可迁移机制”。缺任一项视为 `[BLOCK]`，因为下游会只学到套路，学不到人的情感发动机。
...
| 机制 | 对应学习卡 | 为什么有效 | 写新篇时怎么迁移 | 不能怎么迁移 |
|------|------------|------------|------------------|--------------|
| {关系压力机制} | H{N} | {读者为什么代入/疼/爽} | {换成新关系和新物件后的用法} | {禁止照搬源文桥段或台词} |
| {生活物件机制} | H{N} | {...} | {...} | {...} |
| {选择代价机制} | H{N} | {...} | {...} | {...} |

本段 `[BLOCK]`：至少 3 条机制；每条必须能回答“为什么有效”和“新篇如何迁移”。如果只能写“情绪强/爽点足/节奏快”，说明拆文没有学到人性共鸣来源，回 Stage 3-4 补拆。
