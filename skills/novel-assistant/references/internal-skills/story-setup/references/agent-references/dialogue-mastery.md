...
3. **展示人设**：通过语言风格传递角色性格
4. **回应上一句情绪**：每句对白都要承接、偏转、升级或退缩上一句的情绪压力；只接信息不接情绪，就是机械对话
...
- 角色不能当"科普嘴"：信息型角色也不能整段讲设定/原理/前因后果。Gate G 同样管台词。设定应靠动作、冲突、物件、角色可感知反应零碎带出，用到哪带哪点
...
- **场合例外**：高压、生死、悲痛、严肃兑现 beat 里，搞笑担当/轻快配角的声线必须让位于当前情绪基调。可以保留角色味，但不能用口头梗、插科打诨破坏场合重量
...
- [ ] **机械对话**：是否大量信息靠对白机械倒出、问答式一问一答、句间没有情绪承接？逐句标注承接/偏转/升级/退缩，标不出就改
- [ ] **科普嘴**：是否让角色整段讲设定、原理、来历或因果？把信息拆到动作、冲突、物件后果、半句口语里
- [ ] **不分场合**：高压/生死/悲痛场景里是否仍在玩梗、贫嘴、轻松吐槽？改成短冷、有重量、服务当前情绪的反应
