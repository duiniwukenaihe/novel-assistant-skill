...
读取参考文件时，优先读取项目根目录下的 `.opencode/agent-references/novel-assistant/user-style-learning.md` 或 `.claude/agent-references/novel-assistant/user-style-learning.md`。如果路径不可读，再 fallback 到 `skills/novel-assistant/references/agent-references/user-style-learning.md` 或用 Glob/Grep 搜索 `*/novel-assistant/references/agent-references/user-style-learning.md`。
...
3. 从用户原话中抽取硬约束、软偏好、明确否定、单书设定和角色口吻。
