...
> **作者吸收要求**：加载 [scan-to-author-absorption.md](scan-to-author-absorption.md)。推荐选题不是热词组合，每个选题至少附 1 张作者吸收卡；排名最高的选题附 2 张。吸收卡必须把榜单信号转成“前三章怎么写”的动作。
...
2. 告知用户路径，并说明下一步：「开书时把 `选题决策.md` 放到小说项目根目录，写作会自动读取；想确认"能爆的原因"就先 `/novel-assistant 拆对标书`，拆完会回填。」
