...
一级结构是一个完整单元剧：一个矛盾从起到爆发收束，约 1.5-3 万字 / 数章。拆对标书拆出来的「剧情线 / 章节摘要 / 爽点循环」就是它的一级结构序列；自己卷纲里的「爽点节奏周期」也是一级结构。所以对标节奏不是另起炉灶，而是把对标书的一级结构序列，保留情绪与功能、换素材，搬进自己的卷纲。

### 关键点法（统一各尺度的节奏锚）

任意尺度（全书 / 卷 / 一级结构 / 支线 / 章）都有五个关键点：开场、1/4、中点、3/4、结尾。其中 1/4、中点、3/4 是放关键情节的位置。
...
1. **选段**：在主对标里圈出本卷要对标的一级结构序列。优先读 `剧情/节奏.md`；没有就用 `章节/*_摘要.md`（每个情节点带「类型」「基调」标签）+ `拆文报告.md`（剧情条的章节范围 / 结构分布）。本卷对标几条一级结构约等于本卷字数除以 1.5-3 万。
2. **标关键点**：看对标这几个一级结构在 1/4、中点、3/4 各放了什么关键情节，判为逆转 / 转折 / 激励。摘要里「类型=转折点」的情节点 + 基调突变就是确定性锚。
3. **换素材**：保留对标的情绪链和功能位，把对象、场景、事件全换成自己的。功能位清单优先取 `剧情/情绪模块.md` 可替换项；没有就用摘要「基调」序列 + 剧情条「桥段标签」替代。
4. **修正硬伤**：换素材前比对 `拆文报告.md`「不建议模仿」。对标若在某个关键点弱处理，迁移时补一个缺的关键情节，或把后面的关键情节前置，不能把弱处理一起抄过来。
5. **排章 + 落卷纲**：把换好并修正的关键情节落到本卷相同相对位置。这里的 1/4 / 中点 / 3/4 是卷尺度；卷里有几条一级结构时，每条一级结构内部另有铺垫、逆转和收尾。写进卷纲「对标结构坐标」与情绪弧线的章节定位列，细纲承接时每章标章节定位。

近精细远模糊：只精排当前卷，后续卷做粗坐标即可，不必一上来规划全书。

## 章节定位与张弛（破「每章像短篇」）

一卷里章的压力本就该有高有低。压力级指爆发 / 冲突烈度，不等于情感烈度；关系回收或泪目章可以压力低但情感强。章节定位由“这一章在它所属一级结构里的位置”自然落出，不是另贴一套独立标签。

| 章节定位 | 功能 | 压力级 | 卷内占比（均衡/长书基线，非硬配额） | 钩子要求 |
|------|------|--------|--------------------------|----------|
| 高压章 | 打脸 / 掉马 / 反转 / 高潮；关键点落点 | 4-5 | 约 15-20% | 章尾强钩子；承载逆转 / 转折 |
| 普通推进章 | 主线推进、冲突升级、单元剧中段 | 2-3 | 约 40-50% | 章尾中钩子；至少一个小爽点或期待递进 |
| 修炼试错章 | 实力 / 资源积累、能力铺垫、失败试错 | 2 | 约 5-10% | 进度钩子，可无反转 |
| 关系回收章 | 感情线兑现、关系转折、身边人日常 | 2-3 | 约 5-10% | 情感钩子；拉扯仍带主线相关 |
| 低压生活章 | 高潮后喘息、关系升温、张弛调节 | 1-2 | 不超过约 10% | 允许弱钩子或仅情绪钩子；不强求反转 / 爽点 |
| 信息整理章 | 转场、设定交代、时间缝合 | 1 | 不超过约 5%，能并章就并章、少独立成章 | 允许无显性爽点；信息用表演承载；结尾给下一段目标 |

两条底线：

- **期待不断、爆发分布**。低压章可以没有显性爽点和反转，但每章都要给读者一个往下看的理由。掉的是爆发烈度，不是往前的拉力。
- **禁情绪母题扎堆**。连续多章同一情绪母题高位运行，比缺钩子更容易让读者疲劳。排卷纲情绪弧线时看相邻 3-4 章，同母题别连续超过 2-3 章。

题材分级：番茄短平快 / 男频事业线，高压可到 30% 以上、呼吸章压到 5% 上下都正常；女频 / 世情 / 追妻，关系 / 低压章可更多，但仍走情绪折线。低压 / 关系章定位是看点，不是填充。

与字数预算的衔接：章节定位只改密 / 疏配比的下限，不改总字数契约。高压章靠多密点达成目标字数；低压生活 / 信息整理 / 纯过场章靠铺垫、互动和表演 beat 凑字，不强塞爽点密点。写后字数 <90% 时，高压 / 推进章补密点，低压 / 过场章补铺垫 / 互动 / 表演 beat。
...
- [ ] **对标结构坐标落卷纲**：当前卷如有对标书，已经把对标一级结构、关键点和替换后的本书事件写入卷纲
- [ ] **章节定位有张弛**：细纲标出高压/推进/关系/低压/信息整理等定位，低压章有期待理由，高压章有爆发落点
- [ ] **情绪母题不扎堆**：相邻 3-4 章没有连续同母题高位运行
