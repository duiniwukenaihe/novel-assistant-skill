...
| 废材/落魄天才，修仙世界登顶 | **仙侠/玄幻** | 能力/成长体系必须清晰 |
...
**关键维度**：能力/成长体系清晰不崩 | 金手指独特有限制随成长 | 战斗有策略非纯数值 | 地图逐层展开 | 升级节奏均匀
...
### 世界来源模式：fanfic
同人流派的世界来源模式为 `fanfic`，触发**既有世界观命名护栏**：新增人名、地名、组织名、技术名必须符合原作命名规律。护栏为 advisory——发现偏离时给 advisory 和替代方案，不硬阻断；不因命名护栏阻止用户明确要求的合理改编。不预先硬编码"常见中文名"名单，规律来自原作样例。
...
**世界来源模式：historical_derivative**
历史/架空历史的世界来源模式为 `historical_derivative`，触发**既有世界观命名护栏**：新增人名、地名、组织名、技术名必须符合目标时代与地域的命名规律（如唐宋人名不混晚清用字、地名沿用时代称谓）。护栏为 advisory——发现偏离时给 advisory 和替代方案，不硬阻断；不预先硬编码"常见中文名"名单。
...
### 西幻/骑士文
西幻=东方玄幻内核换皮。骑士自带晋升属性是天然能力/成长体系骨架。推荐DND式/巫师式/种田领主文，不写日式奇幻。开篇从低位开始(马奴/铁匠学徒)，凿壁偷光式努力。
