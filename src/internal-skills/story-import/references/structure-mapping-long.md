...
| 内容块 | 字数 | 目标文件 |
|--------|------|---------|
| 能力/成长规则 | >= 200 字 | 独立为 `能力与规则.md`；按题材可命名为 `修炼与能力规则.md`、`武学与境界.md`、`系统能力与成长规则.md` 等，不默认使用 `力量体系.md` |
| 地理 | >= 200 字 | 独立为 `地理.md` |
| 金手指 | 任意 | 独立为 `金手指.md` |
...
| 主线/支线/任务线索 | 情节安排（主线/辅线/事件线/感情线/逻辑线） | 从剧情线索引与摘要反推；无证据的辅线/感情线写“无”或 `[待补充]`，不得杜撰 |
| 出场角色 / 关键物件 | 人物关系和出场顺序 | 按摘要出现顺序列出；关系变化只写有证据的“前 → 后”，缺失写 `[待补充]` |
| 全部情节点 | 情节细化 / 情节点序列 | 每点写“谁做了什么 + 功能标签”；功能不明写 `[待补充]` |
| 胜负/反转/收益损失 | 代价兑现 / 收益兑现 | 有明确证据才填写；否则 `[待补充]` |
