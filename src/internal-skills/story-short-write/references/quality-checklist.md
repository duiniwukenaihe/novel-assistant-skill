...
> 详细标准见 `short-logic-gate.md`。短篇越短，越不能靠读者脑补关系和动机。

| 检查项 | 标准 |
|--------|------|
| 角色锁定卡 | 每个关键角色都有性别/称谓/视角身份、与主角关系、本篇目标、行动边界、声口和证据物 |
| 主角身份一致 | 主角性别、称谓、职业、年龄不漂移；第一人称女主不得被误写成“儿子/男方/娶妻方” |
| 情节可行性门 | 高价值反转都能回答“谁主动做、为什么现在做、怎么做到、付出什么代价” |
| 巧合预算 | 大巧合不超过 1 个；连续巧合必须改成主角主动设计或前文证据回收 |
| 主题防漂移 | 外部权威/豪门/男人/金钱不能替主角完成主题，高潮必须有主角不可替代行动 |
| 丰满度门 | 每节 3-5 个具体子事件，至少 1 个角色选择和 1 个后果；不得只有“见面/反转/打脸”标签 |
